class Bullet extends GameObject {
  ...
  Bullet(float incomingDX, float incomingDY) {
    bulletPosX = myPlayer.playerPosX+myPlayer.playerHeight/2;  //x position of bullet begins on y position of player
    bulletPosY = myPlayer.playerPosY+myPlayer.playerWidth/2;  //y position of bullet begins on y position of player
    moveVelX = incomingDX;    
    moveVelY= incomingDY;
    //hp = 1;
    bulletWidth = 15;
